...
import com.geekster.moduleclearancetest.RecipeManagementSystemAPI.dto.SignInInput;
import com.geekster.moduleclearancetest.RecipeManagementSystemAPI.dto.SignUpOutput;
...
import com.geekster.moduleclearancetest.RecipeManagementSystemAPI.repository.UserRepository;
import com.geekster.moduleclearancetest.RecipeManagementSystemAPI.service.hashingUtility.PasswordEncrypter;
...
public class UserService {
    ...
    @Autowired
    @Lazy
    public UserService(UserRepository userRepository, AuthenticationService authenticationService, RecipeService recipeService, CommentService commentService) {
    ...
    public String removeRecipe(Long recipeId, String email) {
        ...
        if (recipe != null && recipe.getOwner().equals(user)) {
            ...
            recipeService.removeRecipe(recipeId, user);
